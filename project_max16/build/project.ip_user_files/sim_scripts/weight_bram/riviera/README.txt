...
#
# Generated by export_simulation on Sat May 07 19:34:22 +0900 2022
#
################################################################################
...
'-reset_run' switch to the './weight_bram.sh' script.

./weight_bram.sh -reset_run
...
./weight_bram.sh -noclean_files

For more information on the script, please type './weight_bram.sh -help'.
