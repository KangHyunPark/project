...
#
# Generated by export_simulation on Sat May 07 19:35:49 +0900 2022
#
################################################################################
...
'-reset_run' switch to the './NIT_bram.sh' script.

./NIT_bram.sh -reset_run
...
./NIT_bram.sh -noclean_files

For more information on the script, please type './NIT_bram.sh -help'.
